                        ...
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="product-slider-text-wrapper__text">
                                    ...
                                    <p class="description">Research has revealed that business oil products contain a high level of antioxidants, including tocotrienols, which can have a powerful effect on the overall health of the body. The high antioxidant content makes it a potent addition to your immune system.</p>
                                    <a href="shop-left-sidebar.html" class="slider-text-link">SHOP NOW! <i class="fa fa-caret-right"></i></a>
                                </div>
                            </div>
                            <div class="col-lg-9">
                                        ...
                                        <div class="single-grid-product">
                                            <div class="single-grid-product__image">
                                                ...
                                                <div class="product-hover-icon-wrapper">
                                                    ...
                                                    <span class="single-icon single-icon--add-to-cart"><a href="{{ url('/cart') }}" data-tippy="Coconut Oil" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme = "sharpborder" > <span>Add to Cart</span></a></span>
                                        ...
                                        <div class="single-grid-product">
                                            <div class="single-grid-product__image">
                                                ...
                                                <div class="product-hover-icon-wrapper">
                                                    ...
                                                    <span class="single-icon single-icon--add-to-cart"><a href="{{ url('/cart') }}" data-tippy="Olive Oil" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme = "sharpborder" > <span>Add to Cart</span></a></span>
                                        ...
                                        <div class="single-grid-product">
                                            <div class="single-grid-product__image">
                                                ...
                                                <div class="product-hover-icon-wrapper">
                                                    ...
                                                    <span class="single-icon single-icon--add-to-cart"><a href="{{ url('/cart') }}" data-tippy="Macadonia Oil" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme = "sharpborder" ><span>Add to Cart</span></a></span>
                                        ...
                                        <div class="single-grid-product">
                                            <div class="single-grid-product__image">
                                                ...
                                                <div class="product-hover-icon-wrapper">
                                                    ...
                                                    <span class="single-icon single-icon--add-to-cart"><a href="{{ url('/cart') }}" data-tippy="BlackSeed Oil" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme = "sharpborder" > <span>shop</span></a></span>
                                        ...
                                        <div class="single-grid-product">
                                            <div class="single-grid-product__image">
                                                ...
                                                <div class="product-hover-icon-wrapper">
                                                    ...
                                                    <span class="single-icon single-icon--add-to-cart"><a href="{{ url('/cart') }}" data-tippy="Almond Oil" data-tippy-inertia="true" data-tippy-animation="shift-away" data-tippy-delay="50" data-tippy-arrow="true" data-tippy-theme = "sharpborder" ><span>Add to Cart</span></a></span>
